      ...
      <div className='grid grid-cols-2 gap-4 '>
        <div className='menu flex flex-col gap-3 w-full'>
          ...
          <ul className='flex flex-col gap-1'>
            <li>
              <SplitTextLink
                text={footerHomeLink.name}
                href={footerHomeLink.link}
              />
            </li>
      ...
      <div className='time flex flex-col items-end w-full'>
        <div className=''>
          ...
          <div className='leading-none tracking-wide'>
            <span className='text-black-50 font-mono-custom uppercase'>
              {time},
            </span>
            <span className='text-black-50 font-mono-custom'>
              {' '}
              {footerContent.timezoneLabel}
            </span>
          </div>
        </div>
      </div>
